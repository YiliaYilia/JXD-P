...
<script type="text/javascript" src="${ctx }/business/js/charityPolicy/policyInfo.js"></script>
...
<script type="text/javascript">
	...
	policyInfo.applicantData = [
				...
				{"name": "性别", "group": "${applicant.name }", "value": dictTrans1("${applicant.sex }",'SEX')},
				{"name": "出生日期", "group": "${applicant.name }", "value": "${applicant.birthday }"},
				{"name": "证件类型", "group": "${applicant.name }", "value": dictTrans1("${applicant.identifytype }",'IDTYPE')},
