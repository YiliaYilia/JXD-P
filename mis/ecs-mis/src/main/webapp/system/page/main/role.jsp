...
<script type="text/javascript" src="${ctx }/system/js/role/role.js"></script>
<title>角色管理</title>
...
<body>
	...
	<table>
		<tr>
			...
			<td>
				<a id="search" onclick="searchRoles();" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-search'">查询</a> 
			</td>
		</tr>
	</table>
	</div>
	...
	<!-- 弹出添加操作窗口 --> 
	<div id="role_addUpdate_window" style="background-color:white ;font-size: 15px;padding: 10px;"> 
	</div>
</body>
</html>