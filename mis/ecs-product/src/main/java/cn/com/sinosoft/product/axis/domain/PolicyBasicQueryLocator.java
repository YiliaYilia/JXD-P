...
public class PolicyBasicQueryLocator extends org.apache.axis.client.Service implements cn.com.sinosoft.product.axis.domain.PolicyBasicQuery{
    ...
    public cn.com.sinosoft.product.axis.domain.PolicyBasicQueryPortType getPolicyBasicQueryHttpSoap11Endpoint() throws javax.xml.rpc.ServiceException {
    ...
    public cn.com.sinosoft.product.axis.domain.PolicyBasicQueryPortType getPolicyBasicQueryHttpSoap11Endpoint(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            cn.com.sinosoft.product.axis.domain.PolicyBasicQuerySoap11BindingStub _stub = new cn.com.sinosoft.product.axis.domain.PolicyBasicQuerySoap11BindingStub(portAddress, this);
    ...
    public cn.com.sinosoft.product.axis.domain.PolicyBasicQueryPortType getPolicyBasicQueryHttpSoap12Endpoint() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public cn.com.sinosoft.product.axis.domain.PolicyBasicQueryPortType getPolicyBasicQueryHttpSoap12Endpoint(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            cn.com.sinosoft.product.axis.domain.PolicyBasicQuerySoap12BindingStub _stub = new cn.com.sinosoft.product.axis.domain.PolicyBasicQuerySoap12BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (cn.com.sinosoft.product.axis.domain.PolicyBasicQueryPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                cn.com.sinosoft.product.axis.domain.PolicyBasicQuerySoap11BindingStub _stub = new cn.com.sinosoft.product.axis.domain.PolicyBasicQuerySoap11BindingStub(new java.net.URL(PolicyBasicQueryHttpSoap11Endpoint_address), this);
                _stub.setPortName(getPolicyBasicQueryHttpSoap11EndpointWSDDServiceName());
                return _stub;
            }
            if (cn.com.sinosoft.product.axis.domain.PolicyBasicQueryPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                cn.com.sinosoft.product.axis.domain.PolicyBasicQuerySoap12BindingStub _stub = new cn.com.sinosoft.product.axis.domain.PolicyBasicQuerySoap12BindingStub(new java.net.URL(PolicyBasicQueryHttpSoap12Endpoint_address), this);
                _stub.setPortName(getPolicyBasicQueryHttpSoap12EndpointWSDDServiceName());
                return _stub;
            }
        }
