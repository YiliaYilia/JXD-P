...
public class PolicyInformation  implements java.io.Serializable {
    ...
    private cn.com.sinosoft.product.axis.domain.QueryModel[] model;
    ...
    public PolicyInformation(
           ...
           cn.com.sinosoft.product.axis.domain.QueryModel[] model) {
           this.code = code;
     ...
     * @return model
     */
    public cn.com.sinosoft.product.axis.domain.QueryModel[] getModel() {
        return model;
    }
     ...
     * @param model
     */
    public void setModel(cn.com.sinosoft.product.axis.domain.QueryModel[] model) {
        this.model = model;
    }

    public cn.com.sinosoft.product.axis.domain.QueryModel getModel(int i) {
        return this.model[i];
    }

    public void setModel(int i, cn.com.sinosoft.product.axis.domain.QueryModel _value) {
        this.model[i] = _value;
    }
