 ...
 */
@Entity
@Table(name = "PROPOSAL_PAYMENT_LOG")
public class ProposalPaymentLog implements java.io.Serializable{
	private static final long serialVersionUID = -2952880003330337836L;
