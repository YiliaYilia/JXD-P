...
public class GeApplicantInsured implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8290760334299767490L;
	...
	/** full constructor */
	public GeApplicantInsured(String applicantinsuredno2, String sex, Date birthday, String identifytype, String identifynumber, String zipcode, String companyphone, String homephone, String mobile, String email, String address, String occupationname, String occupationcode, String occupationmname, String occupationmcode, String occupationsname, String occupationscode, String partyflag,
	...
	@Column(name = "APPLICANTINSUREDNO", nullable = false)
	public String getApplicantinsuredno() {
		return this.applicantinsuredno;
	}

	@ManyToMany(targetEntity = cn.com.sinosoft.domain.sale.GePolicy.class)
