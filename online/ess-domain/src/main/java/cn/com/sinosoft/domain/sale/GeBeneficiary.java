...
public class GeBeneficiary implements java.io.Serializable {
	...
	/** full constructor */
	public GeBeneficiary(String beneficiaryno, String benname, String bensex, Date benbirthday, String benidtype, String benidnumber, String benaddress, String benzipcode, String benemail, String bencomphone, String benhomephone, String benmobilephone, String beninterestpercent, String benorder, String benrate, String bentype, String benrelationtopins) {
		this.beneficiaryno = beneficiaryno;
	...
	@Column(name = "BENEFICIARYNO", nullable = false)
