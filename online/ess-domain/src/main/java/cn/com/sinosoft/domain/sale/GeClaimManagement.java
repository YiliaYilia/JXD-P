...
public class GeClaimManagement implements java.io.Serializable {
	...
	private String claimManagementNo;		//主键ID
	...
	private Date startDate;					//被保险人出险日期
	private String startCause;				//被保险人出险原因
	private String occupation;				//被保险人当前职业
	private String phone;					//报案人联系电话
	private String isInsure;				//被保险人是否在其他公司有人身保险（是Y 否N）
