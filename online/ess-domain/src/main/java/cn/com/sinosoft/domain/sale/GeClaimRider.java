...
public class GeClaimRider implements java.io.Serializable {
	...
	private String batchNo;//影像批次号
	private String claimappid;//影像业务交易中理赔id 
	...
	@ManyToOne(targetEntity = cn.com.sinosoft.domain.sale.GeClaimManagement.class)
