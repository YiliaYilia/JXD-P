...
public class DoPrintAnnualReportMsg  implements java.io.Serializable {
    private cn.com.sinosoft.common.service.axis.Xmlheader header;

    private byte[] body;

    public DoPrintAnnualReportMsg() {
    }
    ...
    /**
     * Gets the header value for this DoPrintAnnualReportMsg.
     * 
     * @return header
     */
    ...
    /**
     * Sets the header value for this DoPrintAnnualReportMsg.
     * 
     * @param header
     */
    ...
    /**
     * Gets the body value for this DoPrintAnnualReportMsg.
     * 
     * @return body
     */
    public byte[] getBody() {
    ...
    /**
     * Sets the body value for this DoPrintAnnualReportMsg.
     * 
     * @param body
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DoPrintAnnualReportMsg)) return false;
        DoPrintAnnualReportMsg other = (DoPrintAnnualReportMsg) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DoPrintAnnualReportMsg.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("com.skandia.linkwebService", "doPrintAnnualReportMsg"));
