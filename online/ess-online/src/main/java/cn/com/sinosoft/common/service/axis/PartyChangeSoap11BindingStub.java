/**
 * PartyChangeSoap11BindingStub.java
 *
...
public class PartyChangeSoap11BindingStub extends org.apache.axis.client.Stub implements cn.com.sinosoft.common.service.axis.PartyChangePortType {
    ...
    private static void _initOperationDesc1(){
        ...
        param.setNillable(true);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://model.webservices.sinosoft.com/xsd", "CRSInterfaceModel"));
    ...
    public PartyChangeSoap11BindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public PartyChangeSoap11BindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public PartyChangeSoap11BindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {pcm});
  ...
  throw axisFaultException;
	...
	public CRSInterfaceModel dealPartyTaxType(String partyCode, String taxType,
        ...
        setAttachments(_call);
        try{        
        	java.lang.Object _resp = _call.invoke(new java.lang.Object[] {partyCode,taxType,operate,callBy,country});
            if(_resp instanceof java.rmi.RemoteException) {
            	throw (java.rmi.RemoteException)_resp;
            }else {
            	extractAttachments(_call);
