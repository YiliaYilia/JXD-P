...
public class PolListQueryInterfaceLocator extends org.apache.axis.client.Service implements cn.com.sinosoft.common.service.axis.PolListQueryInterface {
    ...
    public cn.com.sinosoft.common.service.axis.PolListQueryInterfacePortType getPolListQueryInterfaceHttpSoap12Endpoint() throws javax.xml.rpc.ServiceException {
    ...
    public cn.com.sinosoft.common.service.axis.PolListQueryInterfacePortType getPolListQueryInterfaceHttpSoap12Endpoint(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            cn.com.sinosoft.common.service.axis.PolListQueryInterfaceSoap12BindingStub _stub = new cn.com.sinosoft.common.service.axis.PolListQueryInterfaceSoap12BindingStub(portAddress, this);
    ...
    public cn.com.sinosoft.common.service.axis.PolListQueryInterfacePortType getPolListQueryInterfaceHttpSoap11Endpoint() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public cn.com.sinosoft.common.service.axis.PolListQueryInterfacePortType getPolListQueryInterfaceHttpSoap11Endpoint(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            cn.com.sinosoft.common.service.axis.PolListQueryInterfaceSoap11BindingStub _stub = new cn.com.sinosoft.common.service.axis.PolListQueryInterfaceSoap11BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (cn.com.sinosoft.common.service.axis.PolListQueryInterfacePortType.class.isAssignableFrom(serviceEndpointInterface)) {
                cn.com.sinosoft.common.service.axis.PolListQueryInterfaceSoap12BindingStub _stub = new cn.com.sinosoft.common.service.axis.PolListQueryInterfaceSoap12BindingStub(new java.net.URL(PolListQueryInterfaceHttpSoap12Endpoint_address), this);
                _stub.setPortName(getPolListQueryInterfaceHttpSoap12EndpointWSDDServiceName());
                return _stub;
            }
            if (cn.com.sinosoft.common.service.axis.PolListQueryInterfacePortType.class.isAssignableFrom(serviceEndpointInterface)) {
                cn.com.sinosoft.common.service.axis.PolListQueryInterfaceSoap11BindingStub _stub = new cn.com.sinosoft.common.service.axis.PolListQueryInterfaceSoap11BindingStub(new java.net.URL(PolListQueryInterfaceHttpSoap11Endpoint_address), this);
                _stub.setPortName(getPolListQueryInterfaceHttpSoap11EndpointWSDDServiceName());
                return _stub;
            }
        }
