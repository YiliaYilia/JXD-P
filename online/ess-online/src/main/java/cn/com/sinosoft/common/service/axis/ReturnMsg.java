...
public class ReturnMsg  implements java.io.Serializable {
    ...
    /**
     * Gets the header value for this ReturnMsg.
     * 
     * @return header
     */
    ...
    /**
     * Sets the header value for this ReturnMsg.
     * 
     * @param header
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ReturnMsg)) return false;
        ReturnMsg other = (ReturnMsg) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ReturnMsg.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("com.skandia.linkwebService", "ReturnMsg"));
