...
<html>
	...
	<body  onload="backshow()">
		<div class="main_wrap">
			<img src="<%=request.getContextPath() %>/resources/image/calculator/rx0.jpg" class="big_img"/>
			<img src="<%=request.getContextPath() %>/resources/image/calculator/rx1.jpg" class="big_img"/>
			<img src="<%=request.getContextPath() %>/resources/image/calculator/rx2.jpg" class="big_img"/>
			<img src="<%=request.getContextPath() %>/resources/image/calculator/rx3.jpg" class="big_img"/>
			<img src="<%=request.getContextPath() %>/resources/image/calculator/rx4.jpg" class="big_img"/>
			<div class="content">
				<p class="title">瑞享金生终身寿险<br/>保险计划</p>
				<table style="margin-top:10%;height:18%">
					...
					<tr>
						...
						<td >
							<input type="text" id="coverage" name="coverage" onchange="changeIdNo();"/>
						</td>
						<td>
							万
						</td>
         ...
         $("#divM").click(function () {
        	...
        	var insuredage = document.getElementById("insuredage").value;  //投保年龄
       		...
       		if(xingming == "" || xingming.length==0 || xingming == null){
        		...
        		window.location.href="<%=request.getContextPath()%>/action/RXresult?xingming="+xingming+"&insuredage="+insuredage+"&sex="+sex+"&period="+period+"&coverage="+coverage+"";
        	}else{
        		alert("请填写保额!");
        	}   
        });
