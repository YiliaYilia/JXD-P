...
<html>
  <head>
	...
	<style type="text/css">
	.paid{width:100%; text-align:center; font-size:1.3em;margin:0 auto;padding-top:5%;}
	.premium{width:100%;text-align:center;font-size:1.3em;margin:0 auto;padding-top:5%;}
	.success_time{width:100%;text-align:center;font-size:1.3em;margin:0 auto;padding-top:5%;}
  ...
  <body>
		...
		<img src="<%=request.getContextPath() %>/global/global/images/erweima.jpg" style="margin:0 auto" />
			<p  class="success_time" style="margin-top:10px;">扫描二维码关注瑞泰人寿</p>
			<p  class="success_time" style="width:90%;margin-top:20px">点击微信“客户服务”-“保单服务”</p>
			<p  class="success_time" style="width:90%;">-“保单查询”实时查询保单状态。</p>
		</div>
