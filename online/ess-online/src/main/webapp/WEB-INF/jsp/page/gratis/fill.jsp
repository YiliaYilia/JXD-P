...
<body onLoad="dataSelect();">
	...
	<form action="" method="post" name="creator" enctype="multipart/form-data">
		...
		<div class="center_fill">
			<table class="msg">
				...
				<tr>
					<td>
						<select id="province" style="width: 35%;display: none;" name="applicantInsured.province" onchange="select();"></select> 
						<select id="city" style="width: 55%; margin-left: 5%;display: none;" name="applicantInsured.city" onchange="select();"></select>
					</td>
				</tr>
				<tr>
	  				<td  style="color:red; float:right;">&nbsp;</td>
	  				<td  colspan=2 width=100%><input type="hidden" value="北京市" id="showAaddress"></input></td>
	  				<div style="overflow-x: hidden" id="address" />
	...
	<input type="hidden" id="advisorcode" name="policy.agentcode" />
	<input type="hidden" id="advisorname" name="policy.agentname" />	
	<a id="toGratisConfirm"><div class="notice_btn">下一步：确认投保</div></a>
