...
<script type="text/javascript">
	  //提交表单准备投保
	  function dosubmit(){
		  window.location.href ="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx5be4b58fee2539db&redirect_uri=http://weixin.oldmutual-guodian.com/onlineApp/msl/sales/longPreferentialHome&response_type=code&scope=snsapi_base&state=STATE#wechat_redirect";		  
	  }
</script>
