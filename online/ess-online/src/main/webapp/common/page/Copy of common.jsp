...
<link rel="stylesheet" type="text/css" media="screen" href="${ctx }/icbc/investmentlinked/css/login.css">
...
<script type="text/javascript" src="<%=request.getContextPath()%>/icbc/investmentlinked/js/jquery.lightbox_me.js"></script>
