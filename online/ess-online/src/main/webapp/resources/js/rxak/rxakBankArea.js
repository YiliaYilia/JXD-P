...
function select() {
	with (document.getElementById("bankProvinceAddress")) {
	...
	for (i = 0; i < where.length; i++) {
		if (where[i].loca == loca2) {
			...
			for (j = 0; j < loca3.length; j++) {
				with (document.getElementById("bankCityAddress")) {
					length = loca3.length;
	...
	$(document.getElementById("policy.bankProvince")).val(loca2);
	$(document.getElementById("policy.bankCity")).val(loca4);
}
