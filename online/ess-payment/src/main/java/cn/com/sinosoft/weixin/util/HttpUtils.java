...
public class HttpUtils {
	  ...
	  public static void main(String[] args) throws IOException{
		  ...
		  String res=URLEncoder.encode("domain=&ciphertext=55b35beb1015f9d4b143689ce84bdbec9b3c0884&action=validate&account=&password=d41d8cd98f00b204e9800998ecf8427e&ip=192.168.0.123");
