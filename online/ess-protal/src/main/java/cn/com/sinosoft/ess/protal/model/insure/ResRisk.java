 ...
 */
public class ResRisk  extends RiskTbl{
	/**终缴日期*/
	...
	/**投资账户 默认为空*/
	private List<CashValueList> cashValues;
	/** 特别约定*/
	...
	public List<CashValueList> getCashValues() {
		return cashValues;
	}
	public void setCashValues(List<CashValueList> cashValues) {
