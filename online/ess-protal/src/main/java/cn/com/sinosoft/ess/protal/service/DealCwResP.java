...
public class DealCwResP {  
    ...
    public static String toJson( CwResP bean  ) {  
        ...
        public static CwResP getBean(String json) {  
            ...
            for (int i = 0; i < arr.size(); i++) {  
                ...
                Object object = obj.toBean(obj, CwResP.class);  
                CwResP info = (CwResP) object;  
        ...
        public static void main(String[] args) {
        	...
        	CwResP v = getBean(jsonStr);//接收json格式返回报文处理方法 
