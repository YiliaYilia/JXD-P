...
public class CharityPolicyUtil {
	...
	/*public static String calculate(String birthday,String sex,String amnt,String url){
		...
		LCInsured lCInsured = new LCInsured("","林四",sex,birthday,"O","999999","","","","",null,"","","浙江省（市、区）杭州市西湖区县（区）竞舟路西鉴枫景公","310013","","","","","N","CH",risks);
		LCAppnt lcAppnt = new LCAppnt("","林三","M","19831029","O","999888","20100501","20300501","","","","13957171471","浙江省（市、区）杭州市西湖区县（区）竞舟路西鉴枫景公寓","310013","","","linlei101291@sina.com","","120000.00","240000.00","0","CN",null,null,"PA");
		LCInsureds lcInsureds = new LCInsureds("1",lCInsured);
		BaseInfo BaseInfo = new BaseInfo("20150506",sdf.format(new Date()),"803","MSG02","A0000","00000",TransrNo,"102","RT","","1","","","");
		LCCont LCCont = new LCCont("",TransrNo,"20150506","开心保包","MSG02","888888","5","1","","","4","8","","","","","","","RMB","","","","Y","","","",lcAppnt,lcInsureds);
	...
	*/
	 ...
	 * @return
	 */
	public static TranData padding(Risk risk,LCInsured lCInsured,LCAppnt lcAppnt,String flag,LCCont lCCont){
		String TransrNo = getTransrNo();
		//补充被保险人险种信息默认值
	...
	//	lcAppnt.setRelaToInsured("CR");//与被保人关系
		...
		//补充其他信息
		LCInsureds lcInsureds = new LCInsureds("1",lCInsured);
		BaseInfo BaseInfo = new BaseInfo(df.format(new Date()),sdf.format(new Date()),"803","MSG02","A0000","00000",TransrNo,flag,"RT","","1","","","");
		LCCont LCCont = new LCCont("",TransrNo,df.format(new Date()),"","MSG02","888888","5","1",risk.getPrem(),"","4","8","","","","","","","RMB","","","","Y",lCCont.getAccBankCode(),lCCont.getBankProvince(),lCCont.getBankCity(),lcAppnt,lcInsureds);
		if(lCCont.getBankAccNo()!=null){
			LCCont.setBankAccNo(lCCont.getBankAccNo());//续保银行
	 ...
	 * @return
	 */
	public static String underwriting(String url,Risk risk,LCInsured lCInsured,LCAppnt lcAppnt,LCCont lCCont){
		TranData tranData = padding(risk,lCInsured,lcAppnt,"102",lCCont);
		String xmlStr = beanToXML(TranData.class,tranData);
		xmlStr = A2aOra2A(xmlStr,true);
		//发报文并接收
		String responeXml = sendXml(xmlStr,url);
	 ...
	 * @return flag 1成功 0失败
	 */
	public static Map<String,String> approved(String url,Risk risk,LCInsured lCInsured,LCAppnt lcAppnt,LCCont lCCont){
		Map<String,String> map = new HashMap<String,String>();
		TranData tranData = padding(risk,lCInsured,lcAppnt,"100",lCCont);
		String xmlStr = beanToXML(TranData.class,tranData);
		xmlStr = A2aOra2A(xmlStr,true);
		//发报文并接收
		String responeXml = sendXml(xmlStr,url);
	...
	public static String check(ChkDetails chkDetails,String url){
		...
		baseInfo.setZoneNo("MSG02");//地区代码
		baseInfo.setBrNo("MSG02");//网点代码
...
//			if(dailyBalance.getFlag().equals("1")){//交易成功
//				return respone;
//			}else{
//				return dailyBalance.getDesc();
//			}
//		}else{
//			return null;
//		}
...
//		chkDetail.setTranDate("20150806");//保单日期
//		chkDetail.setZoneNo("MSG01");
//		chkDetail.setBrNo("MSG01");
//		chkDetail.setFuncFlag("100");//承保后的单子
//		chkDetail.setTransrNo("1438850718768270");//承保时的流水号
//		chkDetail.setPolNo("TN00002132");//承保的保单号
//		chkDetail.setTranAmnt("500.00");//保费
...
//		System.out.println(check(chkDetails,"http://10.46.101.95:8080/pre/HTTPService"));
//	}
//	
//	
//	
...
//		risk.setAmnt("500000.00");//保额
//		risk.setPrem("400.00");//保费
//		LCInsured lCInsured = new LCInsured();//被保人信息
//		lCInsured.setName("张伟");//被保人姓名
//		lCInsured.setBirthday("20140112");//被保人生日
...
//		System.out.println(underwriting("http://10.46.101.95:8080/pre/HTTPService",risk, lCInsured, lcAppnt,lCCont));
//	}
//	
//	@Test
//	public void 试算(){
//		System.out.println(calculate("20140112","M","500000.00","http://10.46.101.95:8080/pre/HTTPService"));
//	}
//	
//	@Test
//	public void 承保(){
...
//		risk.setCValiDate("20150720");//生效日期
//		risk.setAmnt("500000.00");//保额
//		risk.setPrem("500.00");//保费
//		LCInsured lCInsured = new LCInsured();//被保人信息
//		lCInsured.setName("张伟");//被保人姓名
//		lCInsured.setBirthday("20140112");//被保人生日
//		lCInsured.setSex("M");//被保人性别
//		lCInsured.setIDType("O");//被保人证件类型
//		lCInsured.setIDNo("99888334");//被保人证件号
//		LCAppnt lcAppnt = new LCAppnt();//投保人信息
//		lcAppnt.setAppntName("李文宇");//投保人姓名
//		lcAppnt.setAppntSex("M");//投保人性别
//		lcAppnt.setAppntIDType("I");//投保人证件类型
...
//		lcAppnt.setHomeAddress("北京市海淀区中关村");
//		LCCont lCCont = new LCCont();
//		System.out.println(approved("http://10.46.101.95:8080/pre/HTTPService",risk, lCInsured, lcAppnt,lCCont));
//	}
