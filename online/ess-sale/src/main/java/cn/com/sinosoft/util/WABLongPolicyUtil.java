...
import cn.com.sinosoft.domain.yinbaotongWAB.ChkDetail;
import cn.com.sinosoft.domain.yinbaotongWAB.ChkDetails;
import cn.com.sinosoft.domain.yinbaotongWAB.DailyBalance;
...
public class WABLongPolicyUtil {
	
	public static Logger logger = LoggerFactory.getLogger(WABLongPolicyUtil.class);
	 ...
	 * @return
	 */
	public static String calculate(String birthday,String sex,String amnt,String url,String InsuYear,String brNo,String jobCode,String PayEndYear,String IDNo){
		String TransrNo = getTransrNo();
		//拼报文 
		LCBnfs lcbnfs = new LCBnfs("0",null);
		Accounts acconuts = new Accounts("1");
		Risk risk = new Risk("WENAIBAO","WENAIBAO","","1",amnt,"","20150506","","0.00","","1","",null,"","","4",PayEndYear,"","","","","2",InsuYear,"","","","","","","","",acconuts,"N","N","Y","N",lcbnfs);
		Risks risks = new Risks(1,risk);
		LCInsured lCInsured = new LCInsured("","林四",sex,birthday,"O",IDNo,"","",jobCode,"","","","","浙江省（市、区）杭州市西湖区县（区）竞舟路西鉴枫景公","","","","","","Y","SF","CHN","ZJ","HZ","1",risks);
		LCAppnt lcAppnt = new LCAppnt("","林四",sex,birthday,"O","999888","20100501","21300501","","","","13957171471","浙江省（市、区）杭州市西湖区县（区）竞舟路西鉴枫景公寓","","","","linlei101291@sina.com",jobCode,"0","0","","CHN","ZJ","HZ","SF","1");
	 ...
	 * @return
	 */
	public static TranData padding(Risk risk,LCInsured lCInsured,LCAppnt lcAppnt,LCCont lCCont,BaseInfo baseInfo,LCBnfs lcbnfs ,String payEndYear,String InsuYear){
		...
		risk.setRiskCode("WENAIBAO");
		risk.setMainRiskCode("WENAIBAO");
		...
		risk.setPayEndYear(payEndYear);//缴费期间 10 年 20年
		risk.setPayoutStart("");
		risk.setPayoutEnd("");
		risk.setGetYearFlag("");
		risk.setGetYear("");
		risk.setInsuYearFlag("2");
...
//		risk.setBeneficiaryIndicator("Y"); //受益人法定Y  指定N
	 ...
	 * @return
	 */
	public static String underwriting(String url,Risk risk,LCInsured lCInsured,LCAppnt lcAppnt,LCCont lCCont,BaseInfo baseInfo,LCBnfs lcbnfs,String payEndYear,String InsuYear){
		baseInfo.setFunctionFlag("102");
		TranData tranData = padding(risk,lCInsured,lcAppnt,lCCont,baseInfo, lcbnfs, payEndYear,InsuYear);
		String xmlStr = beanToXML(TranData.class,tranData);
		xmlStr = A2aOra2A(xmlStr,true);
		//发报文并接收
		String responeXml = sendXml(xmlStr,url);
	 ...
	 * @return flag 1成功 0失败
	 */
	public static Map<String,String> approved(String url,Risk risk,LCInsured lCInsured,LCAppnt lcAppnt,LCCont lCCont,BaseInfo baseInfo,LCBnfs lcbnfs,String payEndYear,String InsuYear){
