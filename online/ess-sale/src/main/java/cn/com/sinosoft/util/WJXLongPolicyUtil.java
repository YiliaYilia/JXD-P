...
public class WJXLongPolicyUtil {
	
	public static Logger logger = LoggerFactory.getLogger(WJXLongPolicyUtil.class);
	 ...
	 * @return
	 */
	/*public static String calculate(String birthday,String sex,String identifynumber,String amnt,String url,String brNo){
		String TransrNo = getTransrNo();
		//拼报文 
		LCBnfs lcbnfs = new LCBnfs("0",null);
		Accounts acconuts = new Accounts("1");
		Risk risk = new Risk("WENJIAXING","WENJIAXING","017","1",amnt,"","20150506","","0.00","","1","",null,"","","4","10","","","","","4","30","","","","","","","","",acconuts,"N","N","Y","N",lcbnfs);
		Risks risks = new Risks(1,risk);
		LCInsured lCInsured = new LCInsured("","林四",sex,birthday,"O","999888","","","","","","","","浙江省（市、区）杭州市西湖区县（区）竞舟路西鉴枫景公","310013","","","","","Y","SF",risks);
		LCAppnt lcAppnt = new LCAppnt("","林四",sex,birthday,"O","999888","20100501","21300501","","","","13957171471","浙江省（市、区）杭州市西湖区县（区）竞舟路西鉴枫景公寓","310013","","","linlei101291@sina.com","","120000.00","240000.00","0","CN",null,null,"SF");
	...
	public static TranData padding(Risk risk,LCInsured lCInsured,LCAppnt lcAppnt,LCCont lCCont,BaseInfo baseInfo){
		...
		risk.setRiskCode("WENJIAXING");
		risk.setMainRiskCode("WENJIAXING");
		...
		risk.setYears("");
		risk.setSpecContent("");
		risk.setPayEndYearFlag("4");//缴费方式年
		risk.setPayEndYear("10");//缴费期间
		risk.setPayoutStart("");
		risk.setPayoutEnd("");
		risk.setGetYearFlag("");
		risk.setGetYear("");
...
//	@Test
//	public void shisuan(){
//		System.out.println(calculate("19900112","M","","100000.00","http://10.46.101.95:8080/pre/HTTPService","CQ003"));
//	}
//	
//	//承保测试
